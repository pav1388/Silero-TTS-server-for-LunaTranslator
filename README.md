...
3. Укажите URL сервера: `http://127.0.0.1:23456`.
4. Остальные параметры удалите, нажав на крестики справа.
5. Если надо чтобы настройка Pitch тоже передавалась на сервер (помимо Volume и Speed), то используйте исправление из папки `vitsSimpleAPI_fix`.
